  ...
  const resources = [
    {
      ...
      icon: BookOpen,
      href: "/primary/primary-3/lesson-notes",
      color: "bg-blue-500",
    },
    {
      ...
      icon: FileText,
      href: "/primary/primary-3/schemes-of-work",
      color: "bg-green-500",
    },
    {
      title: "Past Papers",
      ...
      icon: Calendar,
      href: "/primary/primary-3/past-papers",
      color: "bg-purple-500",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Access comprehensive learning materials for Primary Three students.
          </p>
        </div>
