  ...
  const resources = [
    {
      ...
      icon: BookOpen,
      href: "/primary/primary-4/lesson-notes",
      color: "bg-blue-500",
    },
    {
      ...
      icon: FileText,
      href: "/primary/primary-4/schemes-of-work",
      color: "bg-green-500",
    },
    {
      title: "Past Papers",
      ...
      icon: Calendar,
      href: "/primary/primary-4/past-papers",
      color: "bg-purple-500",
    },
  ]
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Primary Four Resources</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Access comprehensive learning materials for Primary Four pupils.
          </p>
        </div>
