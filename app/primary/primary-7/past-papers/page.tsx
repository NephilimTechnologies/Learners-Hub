...
export default function PrimarySevenPastPapersPage() {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Primary Seven Past Papers</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Download previous examination papers and practice tests for Primary Seven
          </p>
        </div>
